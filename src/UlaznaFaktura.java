...
public class UlaznaFaktura {
	...
	public static void main(String[] args) {
		try {
            ...
            java.util.logging.Logger.getLogger(UlaznaFaktura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UlaznaFaktura window = new UlaznaFaktura();
