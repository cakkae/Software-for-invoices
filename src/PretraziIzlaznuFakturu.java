...
public class PretraziIzlaznuFakturu {
	...
	public static void main(String[] args) {
		try {
            ...
            java.util.logging.Logger.getLogger(PretraziIzlaznuFakturu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PretraziIzlaznuFakturu window = new PretraziIzlaznuFakturu();
	...
	private void initialize() {
		...
		podatci = db.ucitajIzlazneFakture();
                	...
                	public void mouseReleased(MouseEvent e)
                	{
                		...
                		if (e.isPopupTrigger() && e.getComponent() instanceof JTable)
                		{
                			...
                			item2.addActionListener(new ActionListener()
                			{
                				...
                				{
                					popup.setVisible(false);
                					db.izbrisiIzlaznuFakturu(selektovanRov);
