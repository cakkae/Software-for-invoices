...
public class IzlaznaFaktura {
	...
	public static void main(String[] args) {
		try {
            ...
            java.util.logging.Logger.getLogger(IzlaznaFaktura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IzlaznaFaktura window = new IzlaznaFaktura();
	...
	private void initialize() {
		...
		lPretrazi.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) 
			{
				PretraziIzlaznuFakturu.main(null);
				ulaznaFaktura.dispose();
			}
		});
		ImageIcon slikaPretraziFakturu = new ImageIcon("slike/pretraziFakturu.png");
