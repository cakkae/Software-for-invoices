...
public class PretraziPredracun {
	...
	public static void main(String[] args) {
		try {
            ...
            java.util.logging.Logger.getLogger(PretraziPredracun.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PretraziPredracun window = new PretraziPredracun();
        		...
        		tabelaSiktarica.addMouseListener(new MouseAdapter()  //1.
                {
                	...
                	public void mouseReleased(MouseEvent e)
                	{
                		...
                		if (e.isPopupTrigger() && e.getComponent() instanceof JTable)
                		{
                			...
                			JButton item = new JButton("Ispiši predraèun");
                			JButton item2 = new JButton("Izbriši predraèun");
                			popup.add(item);
                			popup.add(item2);
                			...
                			item2.addActionListener(new ActionListener()
                			{
                				...
                				{
                					popup.setVisible(false);
                					db.izbrisiPredracun(selektovanRov);
                					JOptionPane.showMessageDialog(null, "Predraèun izbrisan!");
                				}
                			});
                		}
                	}
